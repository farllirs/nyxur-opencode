...
const OPTIONAL = [
  ...
  { name: 'ripgrep', pkg: 'ripgrep', desc: 'Búsqueda rápida en archivos (skills)', critical: false },
  { name: 'jq', pkg: 'jq', desc: 'Procesar JSON (skills)', critical: false },
  { name: 'yq', pkg: 'yq', desc: 'Procesar YAML (skills)', critical: false },
];
